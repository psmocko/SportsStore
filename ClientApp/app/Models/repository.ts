...
export class Repository {
  ...
  getProduct(id: number) {
    this.sendRequest(RequestMethod.Get,  `/api/products/${id}`).subscribe((response) => {
  ...
  replaceSupplier(supp: Supplier) {
    ...
    this.sendRequest(RequestMethod.Put, `${suppliersUrl}/${supp.supplierId}`, data)
      .subscribe(resp => this.getSuppliers());
  }

  deleteSupplier(id: number) {
    this.sendRequest(RequestMethod.Delete, `${suppliersUrl}/${id}`).subscribe(resp => {
      this.getProducts; this.getSuppliers()
    });
  }
