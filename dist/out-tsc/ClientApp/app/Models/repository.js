...
var Repository = /** @class */ (function () {
    function Repository(http) {
        ...
        this.filterObject.related = true;
        this.getProducts();
    }
    ...
    Repository.prototype.getProduct = function (id) {
        var _this = this;
        this.sendRequest(http_1.RequestMethod.Get, "/api/products/" + id).subscribe(function (response) {
    ...
    Repository.prototype.replaceSupplier = function (supp) {
        ...
        this.sendRequest(http_1.RequestMethod.Put, suppliersUrl + "/" + supp.supplierId, data)
            .subscribe(function (resp) { return _this.getSuppliers(); });
    };
    Repository.prototype.deleteSupplier = function (id) {
        var _this = this;
        this.sendRequest(http_1.RequestMethod.Delete, suppliersUrl + "/" + id).subscribe(function (resp) {
            _this.getProducts;
            _this.getSuppliers();
        });
    };
